function [t_main, kin_up, kin_down, kin_int] = fit_transform_movement_direction(t, y, v, a, ma, cat)
...
y_up = y_interp(idk == cat0_id, :);
v_up = v_interp(idk == cat0_id, :);
a_up = a_interp(idk == cat0_id, :);
ma_up = m_interp(idk == cat0_id, :);
...
figure; hold on
plot(t_main, y_interp(idk == cat0_id, :)', 'k-');
